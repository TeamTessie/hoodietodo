      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="update-all.js.html">update-all.js</a></li>
        ...
        <div class="span9">
          <section id="updateAll">
            ...
            <p>
              <div class="label label-info radius ctx-type">function</div><span>hoodie.store.updateAll()</span> -><span>Promise</span>
            </p>
          </section>
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <tr>
                ...
                <td>changed properties or function that                                    alters passed object</td>
              </tr>
            </tbody>
          </table>
          <div class="description"><p>updates all existing objects</p> </div>
        </div>
      </div>
    </div>
    <footer class="footer">
