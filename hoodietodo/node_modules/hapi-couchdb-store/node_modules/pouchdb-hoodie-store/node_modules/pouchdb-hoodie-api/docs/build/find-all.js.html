      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="find-all.js.html">find-all.js</a></li>
        ...
        <div class="span9">
          <section id="findAll">
            ...
            <p>
              <div class="label label-info radius ctx-type">function</div><span>hoodie.store.findAll()</span> -><span>Promise</span>
            </p>
          </section>
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <tr>
                <td>[filter]</td>
                <td>Function</td>
                <td>Function returning `true` for any object                               to be returned.</td>
              </tr>
            </tbody>
          </table>
          <div class="description"><p>finds all existing objects in local database.</p> </div>
        </div>
      </div>
    </div>
    <footer class="footer">
