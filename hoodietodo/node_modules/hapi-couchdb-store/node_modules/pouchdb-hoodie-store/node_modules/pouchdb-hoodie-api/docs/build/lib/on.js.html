      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="../lib/on.js.html">lib/on.js</a></li>
        ...
        <div class="span9">
          <section id="on">
            ...
            <p>
              <div class="label label-info radius ctx-type">function</div><span>hoodie.store.on()</span>
            </p>
          </section>
          ...
          <div class="description"><p>add a listener to an event</p><p>Supported events:</p><ul>
