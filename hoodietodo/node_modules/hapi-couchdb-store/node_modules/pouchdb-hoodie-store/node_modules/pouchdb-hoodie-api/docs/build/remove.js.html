      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="remove.js.html">remove.js</a></li>
        ...
        <div class="span9">
          <section id="remove">
            ...
            <p>
              <div class="label label-info radius ctx-type">function</div><span>hoodie.store.remove()</span> -><span>Promise</span>
            </p>
          </section>
          ...
          <div class="description"><p>removes existing object</p> </div>
        </div>
      </div>
    </div>
    <footer class="footer">
