      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="find.js.html">find.js</a></li>
        ...
        <div class="span9">
          <section id="find">
            ...
            <p>
              <div class="label label-info radius ctx-type">function</div><span>hoodie.store.find()</span> -><span>Promise</span>
            </p>
          </section>
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <tr>
                <td>idOrObject</td>
                <td>String,Object</td>
                <td>Id of object or object with                                      `.id` property</td>
              </tr>
            </tbody>
          </table>
          <div class="description"><p>finds existing object in local database</p> </div>
        </div>
      </div>
    </div>
    <footer class="footer">
