      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="remove-all.js.html">remove-all.js</a></li>
        ...
        <div class="span9">
          <section id="removeAll">
            ...
            <p>
              <div class="label label-info radius ctx-type">function</div><span>hoodie.store.removeAll()</span> -><span>Promise</span>
            </p>
          </section>
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <tr>
                <td>[filter]</td>
                <td>Function</td>
                <td>Function returning `true` for any object                               to be removed.</td>
              </tr>
            </tbody>
          </table>
          <div class="description"><p>removes all existing objects</p> </div>
        </div>
      </div>
    </div>
    <footer class="footer">
