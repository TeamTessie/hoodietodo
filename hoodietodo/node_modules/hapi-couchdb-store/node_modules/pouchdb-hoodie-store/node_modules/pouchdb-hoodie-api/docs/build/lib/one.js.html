      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="../lib/one.js.html">lib/one.js</a></li>
        ...
        <div class="span9">
          <section id="one">
            ...
            <p>
              <div class="label label-info radius ctx-type">function</div><span>hoodie.store.one()</span>
            </p>
          </section>
          ...
          <div class="description"><p>adds a one time listener to an event</p><p>Supported events:</p><ul>
<li><code>add</code>    → (object, options)</li>
<li><code>update</code> → (object, options)</li>
<li><code>remove</code> → (object, options)</li>
<li><code>change</code> → (eventName, object, options)</li>
</ul>
 </div>
        </div>
      </div>
