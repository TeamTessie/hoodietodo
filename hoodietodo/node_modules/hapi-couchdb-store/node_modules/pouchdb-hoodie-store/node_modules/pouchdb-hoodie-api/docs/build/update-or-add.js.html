      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="update-or-add.js.html">update-or-add.js</a></li>
            <li><a href="update.js.html">update.js</a></li>
          </ul>
        </div>
        <div class="span9">
          <section id="updateOrAdd">
            <h1>updateOrAdd</h1>
            <h5 class="subheader"></h5>
            <p>
              <div class="label label-info radius ctx-type">function</div><span>hoodie.store.updateOrAdd()</span> -><span>Promise</span>
            </p>
          </section>
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <tr>
                ...
                <td>id or object with `.id` property, or                                    array of properties</td>
              </tr>
              <tr>
                <td>[properties]</td>
                <td>Object</td>
                <td>If id passed, properties for new                                    or existing object</td>
              </tr>
            </tbody>
          </table>
          <div class="description"><p>updates existing object, or creates otherwise.</p> </div>
        </div>
      </div>
    </div>
    <footer class="footer">
