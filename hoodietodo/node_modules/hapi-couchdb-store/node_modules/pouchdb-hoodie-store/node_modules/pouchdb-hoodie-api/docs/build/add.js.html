      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="add.js.html">add.js</a></li>
        ...
        <div class="span9">
          <section id="add">
            ...
            <p>
              <div class="label label-info radius ctx-type">function</div><span>hoodie.store.add()</span> -><span>Promise</span>
            </p>
          </section>
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <tr>
                <td>properties</td>
                <td>Object,Object[]</td>
                <td>Properties of one or                                        multiple objects</td>
              </tr>
            </tbody>
          </table>
          <div class="description"><p>adds one or multiple objects to local database</p> </div>
        </div>
      </div>
    </div>
    <footer class="footer">
