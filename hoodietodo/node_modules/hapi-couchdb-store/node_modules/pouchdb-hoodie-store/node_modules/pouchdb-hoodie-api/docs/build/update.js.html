      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="update.js.html">update.js</a></li>
          </ul>
        </div>
        <div class="span9">
          <section id="update">
            ...
            <p>
              <div class="label label-info radius ctx-type">function</div><span>hoodie.store.update()</span> -><span>Promise</span>
            </p>
          </section>
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>Changed properties or function                                        that changes existing object</td>
              </tr>
            </tbody>
          </table>
          <div class="description"><p>updates existing object.</p> </div>
        </div>
      </div>
    </div>
    <footer class="footer">
