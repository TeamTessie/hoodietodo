      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="clear.js.html">clear.js</a></li>
        ...
        <div class="span9">
          <section id="clear">
            ...
            <p>
              <div class="label label-info radius ctx-type">function</div><span>hoodie.store.clear()</span>
            </p>
          </section>
          <div class="description"><p>destroys db</p> </div>
        </div>
      </div>
    </div>
    <footer class="footer">
