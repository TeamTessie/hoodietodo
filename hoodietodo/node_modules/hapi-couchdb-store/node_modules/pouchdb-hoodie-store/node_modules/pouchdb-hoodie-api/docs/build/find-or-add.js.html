      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="find-or-add.js.html">find-or-add.js</a></li>
        ...
        <div class="span9">
          <section id="findOrAdd">
            <h1>findOrAdd</h1>
            <h5 class="subheader"></h5>
            <p>
              <div class="label label-info radius ctx-type">function</div><span>hoodie.store.findOrAdd()</span> -><span>Promise</span>
            </p>
          </section>
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <tr>
                <td>idOrObject</td>
                <td>String,Object</td>
                <td>id or object with `.id` property</td>
              </tr>
              <tr>
                <td>[properties]</td>
                <td>Object</td>
                <td>Optional properties if id passed                                      as first option</td>
              </tr>
            </tbody>
          </table>
          <div class="description"><p>tries to find object in local database, otherwise creates new one<br />with passed properties.</p> </div>
        </div>
      </div>
    </div>
    <footer class="footer">
