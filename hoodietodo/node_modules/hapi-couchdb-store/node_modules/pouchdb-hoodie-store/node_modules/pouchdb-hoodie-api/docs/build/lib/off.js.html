      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="../lib/off.js.html">lib/off.js</a></li>
        ...
        <div class="span9">
          <section id="off">
            ...
            <p>
              <div class="label label-info radius ctx-type">function</div><span>hoodie.store.off()</span>
            </p>
          </section>
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <tr>
                <td>eventName</td>
                <td>String</td>
                <td>        Name of event, one of listed above</td>
              </tr>
              <tr>
                <td>handler</td>
                <td>Function</td>
                <td>        callback for event</td>
              </tr>
            </tbody>
          </table>
          <div class="description"><p>removes a listener for the specified event</p><p>It will unsubscribe at most, one instance of a listener for a particular event.<br />If any single listener has subcribed multiple times to the same event,<br />then <code>off</code> must be called multiple times.</p><p>Supported events:</p><ul>
<li><code>add</code></li>
